...
void parse_common_color(struct native_view *v, struct xml_attribute *a, struct native_parser *p, struct native_parser *parent)
{
        if(a->value->len && a->value->ptr[0] == '#') {
                if(a->value->len == 7) {
                        ...
                        native_view_set_color(v, &(union vec4){
                                r / 255.0f,
                                g / 255.0f,
                                b / 255.0f,
                                1.0f
