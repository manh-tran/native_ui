...
{
        struct native_view_image_view_data *p   = smalloc(sizeof(struct native_view_image_view_data), image_view_data_free);
...
{
        struct native_view_list_view_data *p    = smalloc(sizeof(struct native_view_list_view_data), native_view_list_view_data_free);
        p->bouncing                             = 0;
        p->hold                                 = 0;
...
{
        struct native_view_label_data *p        = smalloc(sizeof(struct native_view_label_data), native_view_label_data_free);
